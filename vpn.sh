...
wget -q -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/Ianqitgu742543/caxacacacacaxl/main/vars.conf"
...
# install openvpn
wget -q -O /etc/openvpn/vpn.zip "https://raw.githubusercontent.com/Ianqitgu742543/caxacacacacaxl/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
