...
wget -q -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/Ianqitgu742543/caxacacacacaxl/main/accel.conf"
...
#input perintah sstp
wget -q -O /usr/bin/add-sstp https://raw.githubusercontent.com/Ianqitgu742543/caxacacacacaxl/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -q -O /usr/bin/del-sstp https://raw.githubusercontent.com/Ianqitgu742543/caxacacacacaxl/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -q -O /usr/bin/cek-sstp https://raw.githubusercontent.com/Ianqitgu742543/caxacacacacaxl/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -q -O /usr/bin/renew-sstp https://raw.githubusercontent.com/Ianqitgu742543/caxacacacacaxl/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
